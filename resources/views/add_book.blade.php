...
<div class="page w-50 mx-auto my-5">
    ...
    <form action="{{ route('books.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input value="{{ old('rating') }}" name="rating" type="number"
        ...
        <div class="mb-3">
            ...
            <input value="{{ old('author_name') }}" name="author_name" type="text"
        ...
        <div class="mb-3">
            ...
            <input value="{{ old('ISBN') }}" name="ISBN" type="text"
        ...
        <div class="mb-3">
            ...
            <input value="{{ old('publish_date') }}" name="publish_date" type="date"
        ...
        <div class="mb-3">
            ...
            <select name="genre" id="genre" class="form-control @error('genre') is-invalid @enderror">
                ...
                <option value="science-fiction" {{ old('genre') == 'science-fiction' ? 'selected' : '' }}>Science
                    Fiction
                </option>
        ...
        <div class="mb-3">
            ...
            <select name="type" id="type"
                ...
                <option value="paperback" {{ old('type') == 'paperback' ? 'selected' : '' }}>Paperback</option>
                <option value="hard" {{ old('type') == 'hard' ? 'selected' : '' }}>Hard</option>
                <option value="kindle" {{ old('type') == 'kindle' ? 'selected' : '' }}>Kindle</option>
            </select>
